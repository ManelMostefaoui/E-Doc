...
export default function ContactCenter({ currentPage, navigateTo }) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center space-y-4 md:space-y-0">
          ...
          <button className="text-[#f7f9f9] bg-[#008080] font-semibold flex items-center gap-4 border-2 border-[#008080] rounded-lg px-13 py-2 hover:bg-[#006666] transition duration-150">
          Contact the doctor
          </button>
