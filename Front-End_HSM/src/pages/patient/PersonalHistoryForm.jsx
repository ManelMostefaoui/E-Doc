  ...
  return (
    ...
    <div className="bg-[#f7f9f9] rounded-xl shadow-[2px_2px_12px_rgba(0,0,0,0.25)] w-full max-w-2xl p-3  border border-gray-100 overflow-hidden">
      ...
      <div className="flex justify-between items-center py-3 px-7 mt-4 ">
        <h2 className="font-nunito text-[30px] text-[#008080] font-bold text-center flex-grow">Personal History :</h2>
      ...
      <div className="scrollable-container max-h-[60vh] overflow-y-auto px-12 py-2 mr-6 font-nunito text-[16px]">
       
        {/* Tobacco Section */}
        <div className="mb-6">
          <h3 className="text-[#008080] font-semibold mb-4">Tabacco :</h3>
        ...
        {/* Alcohol Section */}
        <div className="mb-6">
          <h3 className="text-[#008080] font-semibold mb-4">Alchool :</h3>
          ...
          <div className="space-y-4">
            ...
            {renderField("Periode of exposure :", "periodeOfExposure", "select", [
        ...
        {/* Medications Section */}
        <div className="mb-6">
          <h3 className="text-[#008080] font-semibold mb-4">Medications :</h3>

          <div className="space-y-4">
            {renderField("Current :", "currentMedications", "input")}
            {renderField("Past :", "pastMedications", "input")}
          </div>
        </div>
      </div>
